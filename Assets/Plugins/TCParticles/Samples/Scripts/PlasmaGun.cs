...
public class PlasmaGun : MonoBehaviour {
	...
	IEnumerator FireGrenade()
	{
		...
		gr.rigidbody.velocity = Camera.main.transform.forward * grenadeShotPower + cc.velocity + new Vector3(0.0f, grenadeVerticalPower, 0.0f);
	...
	IEnumerator FirePlasma()
	{
		...
		plasma.rigidbody.velocity = Camera.main.transform.forward * plasmaShotPower + cc.velocity;
